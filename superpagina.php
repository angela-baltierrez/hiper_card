		...
		<div class="container">
			<div class="row w-100 align-items-center gx-lg-2 gx-0">
				...
				<div class="col-md-2 col-xxl-3 d-none d-lg-block">
					...
					<button style="background-color: #fff;" type="button" class="btn btn-outline-gray-400 text-muted" data-bs-toggle="modal" data-bs-target="#locationModal">
						<i style="color: #2da82d;" class="feather-icon icon-map-pin me-2"></i>
						Locacion
					</button>
				</div>
				...
				<div class="offcanvas-body">
						...
						<div class="collapse mt-2" id="collapseExample">
							<div class="card card-body">
								<ul class="mb-0 list-unstyled">
									<li><a class="dropdown-item" href="departamentos.html">Dairy, Bread & Eggs</a></li>
					...
					<div class="dropdown me-3 d-none d-lg-block">
						...
						<ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
							<li><a class="dropdown-item" href="departamentos.html">Dairy, Bread & Eggs</a></li>
							<li><a class="dropdown-item" href="departamentos.html">Snacks & Munchies</a></li>
							<li><a class="dropdown-item" href="departamentos.html">Frutas & Vegetables</a></li>
							<li><a class="dropdown-item" href="departamentos.html">Cold Drinks & Juices</a></li>
							<li><a class="dropdown-item" href="departamentos.html">Breakfast & Instant Food</a></li>
							<li><a class="dropdown-item" href="departamentos.html">Bakery & Biscuits</a></li>
							<li><a class="dropdown-item" href="departamentos.html">Chicken, Meat & Fish</a></li>
						</ul>
					</div>
					...
					<div class="hero-slider">
						<div style="background: url(./assets/images/slider/slide-1.jpg) no-repeat; background-size: cover; border-radius: 0.5rem; background-position: center">
							<div class="ps-lg-12 py-lg-16 col-xxl-5 col-md-7 py-14 px-8 text-xs-center">
								...
								<a href="registro.html" class="btn btn-dark mt-3">
									Registrate
